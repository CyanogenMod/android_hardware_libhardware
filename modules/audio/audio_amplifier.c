...
static int amp_stream_start(amplifier_device_t *device,
        struct audio_stream_out *stream, bool offload)
{
    return 0;
}

static int amp_stream_standby(amplifier_device_t *device,
        ...
        hw_device_t **device)
{
    ...
    amp_dev->set_devices = amp_set_devices;
    amp_dev->set_mode = amp_set_mode;
    amp_dev->stream_start = amp_stream_start;
    amp_dev->stream_standby = amp_stream_standby;
