...
static int amp_open(struct amplifier_module *module)
{
    return 0;
}

static void amp_set_devices(struct amplifier_module *module, int devices)
{
}

static int amp_set_mode(struct amplifier_module *module,
        struct audio_mode_t mode)
{
    return 0;
}

static void amp_stream_start(struct amplifier_module *module,
        struct audio_stream_out *stream, bool offload)
{
}

static void amp_stream_standby(struct amplifier_module *module,
        struct audio_stream_out *stream)
{
}

static int amp_close(struct amplifier_module *module)
{
    return 0;
}
